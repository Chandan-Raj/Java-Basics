...
<script src="<c:url value="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"/>" integrity="sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa" crossorigin="anonymous"></script>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="<c:url value="Resource/bootstrap.min.css"/>"rel="stylesheet">
...
<body>
    ...
    <div class="brand"><h1>Shopping Cart</h1></div>
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <hr>
                    <img class="img-responsive img-border img-left" src="img/intro-pic.jpg" style=width:250px alt="">
                    <hr class="visible-xs">
